...
public class EstudianteDTO {
    ...
    */
    public Estudiante crearestudianteDTO(long cc, String n, String a, String p) throws InputMismatchException{
   /*     I.mostrar_mensaje("Datos para Crear Estudiante");
    ...
    public Estudiante actualizarestudianteDTO(long cc, String p)throws InputMismatchException{
    ...
    public Estudiante consultarestudianteDTO(long cc)throws InputMismatchException{
        //Solo podra modificar el programa
    ...
    public Estudiante eliminarestudianteDTO(long cc)throws InputMismatchException{
        //Solo podra modificar el programa
